...
class AppTheme {
  ...
  static const _AppPalette _lightPalette = _AppPalette(
    ...
    surfaceHover: Color(0xFFF9FCFA),
    surfaceActive: Color(0xFFE7F7F0),
    border: Color(0xFFE3ECE7),
    borderLight: Color(0xFFCFE3DA),
    textPrimary: Color(0xFF1F2933),
    textSecondary: Color(0xFF667085),
    textTertiary: Color(0xFF98A2B3),
    accent: Color(0xFF0F9F6E),
    accentHover: Color(0xFF0B8A5F),
    danger: Color(0xFFDC2626),
    userBubble: Color(0xFFE5F8F0),
    assistantBubble: Color(0xFFFFFFFF),
    shellGradientA: Color(0xFFFFFFFF),
    shellGradientB: Color(0xFFF6FAF8),
    shellGradientC: Color(0xFFE7F7F0),
    panelShadow: Color(0x140F2319),
  );
