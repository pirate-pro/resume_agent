...
def test_markdown_chunking_preserves_code_blocks_tables_and_offsets() -> None:
    text = """# RAG 复盘
...
def test_build_retrieval_chunks_sets_source_refs_scope_and_stable_ids() -> None:
    ...
    now = datetime(2026, 5, 16, 9, 30, tzinfo=APP_TIMEZONE)
    ...
    assert chunks[0].owner_user_id == "user_alpha"
    assert chunks[0].workspace_id == "workspace_alpha"
